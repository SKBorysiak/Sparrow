...
public class UserDAO extends AbstractDao {
    ...
    public List<User> getUserByLastName(String lastName) {
        TypedQuery<User> query = entityManager.createQuery("select u from User u where name = :lastName", User.class);
    ...
    public List<User> getNotFollowedUsers(String login) {
        ...
        //TODO implement query with left join relation to follows followed table
